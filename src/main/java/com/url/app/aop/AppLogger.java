...
public class AppLogger {
	...
	@Around("(within(@org.springframework.stereotype.Controller *) || within(@org.springframework.web.bind.annotation.RestController *)) && (execution(* com.url.app.controller.*.*(..)) || execution(* com.url.app.restcontroller.*.*(..)))")
