...
<head>
	...
	<title>${appTitle} | Course Types</title>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li><a href="${contextPath}courseType/list">Course Type</a></li>
					</c:if>
								...
								<div class="box-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											...
											<label id="courseTypeCodeError" for="courseTypeCode" class="control-label errMsgCls hidden"></label>
										</div>
									</div>
									</c:if>
									<div class="form-group">
										<label for="courseTypeName" class="col-sm-2 control-label">Course Type Name*</label>

										<div class="col-sm-8">
											<input type="text" id="courseTypeName" name="courseTypeName" maxlength="500" class="form-control" placeholder="Course Type Name">
											<label id="courseTypeNameError" for="courseTypeName" class="control-label errMsgCls hidden"></label>
										</div>
									</div>
									<div class="form-group">
										<label for="noOfDays" class="col-sm-2 control-label">No Of Days</label>

										<div class="col-sm-8">
											<input type="text" id="noOfDays" name="noOfDays" maxlength="100" class="form-control" placeholder="No Of Days">
											<label id="noOfDaysError" for="noOfDays" class="control-label errMsgCls hidden"></label>
										</div>
									</div>
								</div>
								<!-- /.box-body -->
