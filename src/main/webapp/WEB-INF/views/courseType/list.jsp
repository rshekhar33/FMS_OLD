...
<head>
	...
	<title>${appTitle} | All Course Types</title>
	<!-- Font Awesome Icons -->
...
<body class="hold-transition sidebar-mini text-sm layout-fixed layout-navbar-fixed layout-footer-fixed">
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Course Type Listing</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">List Course Types</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">List Course Types</h3>
							</div>
							<!-- /.card-header -->
							<div class="card-body">
	...
	<script>
		...
		var activationIsAllowed = ${appAuthorization.isAccessAllowed('courseType/activation')};
		var updateIsAllowed = ${appAuthorization.isAccessAllowed('courseType/update')};
	</script>
	<script src="${contextPath}js/common.js"></script>
	<script src="${contextPath}js/pages/courseType/list.js"></script>
</body>
</html>