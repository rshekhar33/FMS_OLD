		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
						...
						<li>
							...
							<ul class="menu">
								...
								<li>
									<a href="#">
										<div class="pull-left">
											<img src="${contextPath}images/user3-128x128.jpg" class="img-circle" alt="User Image">
										</div>
								...
								<li>
									<a href="#">
										<div class="pull-left">
											<img src="${contextPath}images/user4-128x128.jpg" class="img-circle" alt="User Image">
										</div>
					...
					<ul class="dropdown-menu">
						...
						<li>
							...
							<ul class="menu">
								...
								<li>
									<a href="#"><i class="fa fa-users text-red"></i>
										5 new members joined
									</a>
								</li>
								<li>
									<a href="#"><i class="fa fa-shopping-cart text-green"></i>
										25 sales made
									</a>
								</li>
								<li>
									<a href="#"><i class="fa fa-user text-red"></i>
				...
				<li class="dropdown user user-menu">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						<img src="${contextPath}images/user2-160x160.jpg" class="user-image" alt="User Image">
					...
					<ul class="dropdown-menu">
						...
						<li class="user-footer">
							...
							<div class="pull-right">
								<a href="javascript:;" onclick="document.getElementById('logoutForm').submit();" class="btn btn-default btn-flat">Sign out</a>
								<form action="${contextPath}logout" method="post" id="logoutForm">
									<sec:csrfInput/>
								</form>
								<form action="" method="post" id="linkForm">
									<sec:csrfInput/>
									<input name="linkId" id="linkId" type="hidden" value=""/>
								</form>
							</div>
						</li>
					</ul>
